...
export default () =>{
  const [trocar, setTrocar]=useState(<Teste tipo={'caminhoes'} />);
  const [selected, setSelected] = useState('')
  const [veiculo, setVeiculo] = use
  ...
  return (
   ...
   <BotaoCarros onPress={()=>setTrocar(<Teste tipo={'carros'} />)}>
       <IconCar 
   ...
   <ButtonCycle  onPress={()=>setTrocar(<Teste tipo={'motos'} />)} >
        <IconMoto  source={require('../../Assets/Moto.png')}  />
        <TextMoto>Motos</TextMoto>
   </ButtonCycle>

   <ButtonTrucks  onPress={()=>setTrocar(<Teste tipo={'caminhoes'} />)} >
        <IconTruck 
