...
interface TesteProps { setAtivarCar: React.Dispatch<React.SetStateAction<boolean>>}




export default ({navigation, props} : TesteProps) =>{
  ...
  const [ativarCar, setAtivarCar] = useState(false)
