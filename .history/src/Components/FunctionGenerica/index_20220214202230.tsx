...
interface TesteProps {tipo:string; setSelected:React.Dispatch<React.SetStateAction<string>>; selected:string; setSelectedname:React.Dispatch<React.SetStateAction<string>>; } 
