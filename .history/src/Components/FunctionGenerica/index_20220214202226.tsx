...
interface TesteProps {tipo:string; setSelected:React.Dispatch<React.SetStateAction<string>>; selected:string; setSelectedn:React.Dispatch<React.SetStateAction<string>>;} 
